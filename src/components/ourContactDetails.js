...
const OurContactDetails = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-start min-h-screen w-full bg-[#ffe5e5] overflow-x-hidden border-black border-b-4">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-1/2 flex flex-col justify-center items-center bg-white border-2 border-black shadow-lg rounded-lg p-6 transform transition duration-300 hover:scale-[1.02] hover:shadow-xl text-center mb-8 lg:mb-0">
            <div className="space-y-6">
              ...
              <p className="text-xl sm:text-2xl text-black">
                If you have a plan in mind already and want to get started, please use the form.
              </p>
            </div>
            <p className="font-body text-s mt-8 mb-2">Follow us</p>
            <div className="flex justify-center space-x-6">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-black hover:text-gray-600 transition-colors duration-200">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <form className="bg-white border-2 border-black shadow-lg rounded-lg p-6 flex flex-col justify-between transform transition duration-300 hover:scale-[1.02] hover:shadow-xl">
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" id="name" name="name" className="w-full px-4 py-2 border-2 border-black rounded" required />
                </div>
                <div>
                  <label htmlFor="email" className="block text-lg font-semibold mb-2">Email</label>
                  <input type="email" id="email" name="email" className="w-full px-4 py-2 border-2 border-black rounded" required />
                </div>
                <div>
                  <label htmlFor="phone" className="block text-lg font-semibold mb-2">Phone Number</label>
                  <input type="tel" id="phone" name="phone" className="w-full px-4 py-2 border-2 border-black rounded" />
                </div>
                <div>
                  <label htmlFor="message" className="block text-lg font-semibold mb-2">Message</label>
                  <textarea id="message" name="message" rows="4" className="w-full px-4 py-2 border-2 border-black rounded" required></textarea>
                </div>
              </div>
              <button type="submit" className="w-full bg-black text-white py-3 px-6 rounded text-lg font-semibold hover:bg-gray-800 transition duration-200 mt-6">
                Send Message
              </button>
            </form>
          </div>
...
export default OurContactDetails;